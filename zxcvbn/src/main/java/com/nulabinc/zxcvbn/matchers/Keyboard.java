...
public class Keyboard {
    ...
    private static Keyboard QWERTY = null;
    private static Keyboard DVORAK = null;
    private static Keyboard JIS = null;
    private static Keyboard KEYPAD = null;
    private static Keyboard MAC_KEYPAD = null;
    static List<Keyboard> ALL_KEYBOARDS;
    ...
    public static void initKeyboard(@ApplicationContext Context context) {
        if (QWERTY == null) {
            QWERTY = new Keyboard("qwerty", new SlantedAdjacentGraphBuilder(loadAsString(context, "matchers/keyboards/qwerty.txt")));
        }
        if (DVORAK == null) {
            DVORAK = new Keyboard("dvorak", new SlantedAdjacentGraphBuilder(loadAsString(context, "matchers/keyboards/dvorak.txt")));
        }
        if (JIS == null) {
            JIS = new Keyboard("jis", new SlantedAdjacentGraphBuilder(loadAsString(context, "matchers/keyboards/jis.txt")));
        }
        if (KEYPAD == null) {
            KEYPAD = new Keyboard("keypad", new AlignedAdjacentAdjacentGraphBuilder(loadAsString(context, "matchers/keyboards/keypad.txt")));
        }

        if (MAC_KEYPAD == null) {
            MAC_KEYPAD = new Keyboard("mac_keypad", new AlignedAdjacentAdjacentGraphBuilder(loadAsString(context,
                    "matchers/keyboards/mac_keypad.txt")));
        }
        if (ALL_KEYBOARDS == null) {
            ALL_KEYBOARDS = Arrays.asList(QWERTY, DVORAK, JIS, KEYPAD, MAC_KEYPAD);
        }
    }
